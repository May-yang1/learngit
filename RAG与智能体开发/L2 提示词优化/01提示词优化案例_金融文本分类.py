...
example_datas = {   # 示例数据
    ...
    "分析师报告": "最新的行业分析报告指出，科技公司的创新将成为未来增长的主要推动力。云计算、人工智能和数宁化转型被认为是引领行业发展的关键因素，投资"
}
...
questions = [
    ...
    "ABC公司令日发布公告称，已成功完成对XYZ公司股权的收购交易。本次交易是ABC公司在扩大业务范围、加强市场竞争力方面的重要举措。据悉，此次收购将进一步",
...
[
    ...
    {"role":"user",     "content":"公司资财负债表显示,公司偿债能力强劲,现金流充足........................."},
    {"role":"assistant","content":"公司公告"},
    {"role":"user",     "content":"最新的分析报告指出,可再生能源........................."},
    {"role":"assistant","content":"分析师报告"},
    
    {"role":"user",     "content":"要提出的问题"}
]
"""
messages = [
    {"role":"system",   "content":"你是金融专家,将文本分类为['新闻报道','财务报告','公司公告','分析师报告'],不清楚的分类为'不清楚类别'"}
]
for key,value in example_datas.items():
